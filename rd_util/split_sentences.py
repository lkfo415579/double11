...
__author__ = "Ondřej Dušek,REVO"
__date__ = "2017-10-26,V1.1"
...
class SentenceSplitter(object):
    ...
    def split_sentences(self, text):
        ...
        """
        # clean
        # q2bfile = codecs.open('/var/local/www/radiant/app/util/q2b','r','utf8')
        # q2b = q2bfile.readlines()
        # for line in q2b:
            # temp = line.strip('\n').split('/')
        ...
        for item in raw_list:
            num_of_words = item.split(' ')
            if num_of_words > 200:
                subitems = self.chunkstring(item,250)
...
def split_str_into_len(s, l=200):
